...
- Infrastructure costs, tracked as regular expenses.
  ...
  - Services that are to be phased out or slimmed down
...
- **Architecture**: "That which is too expensive to change (now)." - Really, that is the beste definition on software architecture!

  - **Architectural Debt**: System components too costly to change now.

  - **Technical Debt**: Undesirable elements in the system: known or unknown.

- **Tactical Debt**: Undesirable elements in the system willingly taken on out of pragamtism.
...
- Move the Tech Debt Items out of the grooming bucket and into a work-package or equivilent that management can see
