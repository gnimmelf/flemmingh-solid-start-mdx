...
<Experience
  primary='Angular real-time sensor HMI'
  secondary='Kongsberg'
...
>
Creating Angular frontends for real-time data streaming from MQTT backends via SignalR into signal-based CQRS systems with data visualizations.
Main focus on data-driven architectural robustess and GUI standards and guidelines for situational awareness during high-stress situations.
</Experience>
